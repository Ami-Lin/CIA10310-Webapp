...
%>
--<%= memberVO==null %>--${memberVO.city}--<!-- line 100 改爽的 -->
<html>
<head>
...
<table>
	...
	<tr>
		<td>會員帳號:</td>
		<td><input type="TEXT" name="ac" value="<%=memberVO.getAc()%>" size="45"/></td>
	</tr>
	<tr>
		<td>會員密碼:</td>
		<td><input type="TEXT" name="pw" value="<%=memberVO.getPw()%>" size="45"/></td>
	</tr>
	<tr>
		<td>電子郵件:</td>
	...
	<tr>
		<td>性別:</td>
		<td><input name="sex" type="text" value="<%=memberVO.getSex()%>" size="45"></td>
	</tr>
	<tr>
		<td>電話:</td>
	...
	<tr>
		<td>市:</td>
		<td><input type="TEXT" name="city" value="<%=memberVO.getCity()%>" size="45"/></td>
	</tr>
	<tr>
		<td>區:</td>
		<td><input type="TEXT" name="disc" value="<%=memberVO.getDisc()%>" size="45"/></td>
	</tr>
	<tr>
		<td>地址:</td>
	...
	<tr>
		<td>會員照片:</td>
		<td><input type="FILE" name="img" value="<%=memberVO.getImg()%>"></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=memberVO.getBirth()%>', // value:   new Date(),
