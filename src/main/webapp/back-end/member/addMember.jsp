...
<%-- 	 value="<%= memberVO.getBirth()%>"  --%>
	...
	<tr>
		<td>市:</td>
		<td><input type="TEXT" name="city" value="<%= (memberVO==null)? "新北市" : memberVO.getCity()%>" size="45"/></td>
	</tr>
	<tr>
		<td>區:</td>
		<td><input type="TEXT" name="disc" value="<%= (memberVO==null)? "土城區" : memberVO.getDisc()%>" size="45"/></td>
	</tr>
	<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="address" value="<%= (memberVO==null)? "學府路一段" : memberVO.getAddress()%>" size="45"/></td>
	</tr>
	<tr>
		<td>會員照片:</td>
